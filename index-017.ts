// You can assign an empty array by assigning it to []

// Arrays:
let bestNumbers2: number[] = [7,77,4];
let bestLunches2: string[] = ['chicken soup', 'non-chicken soup'];
let bestBreakfasts2: string[]= ['fasting', 'oatmeal', 'tamago kake gohan', 'any kind of soup'];
...
let numbersMulti : number[][][] = [ [[1],[2,3]], [[7],bestNumbers2] ];